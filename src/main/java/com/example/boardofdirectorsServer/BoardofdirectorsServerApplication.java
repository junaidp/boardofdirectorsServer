...
//				Entry entry = new Entry("Lease No. 1", new Date("10/05/2020"), "Beginning", 5, 10, 2, 2670000, "Monthly", 0, 1000000, 10, 30, 10, 2021, 04);
//			//	c.entry(entry);
//				
//				Calculation c = new Calculation();
//				String map = c.entryJournal(entry, TYPES.JOURNAL_MONTHLY, TYPES.LEASE_YEARLY);
//				Gson gson = new Gson(); 
